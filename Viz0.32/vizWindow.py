...
# =============================================================================
            ...
            for (index,port) in enumerate(comList):
                actionList[index].triggered.connect(lambda: self.__optionUpdated("com", '"{0}"'.format(actionList[index].text())))
