...
class displayMat(qw.QTableView):
    def __init__(self, state):
        ...
        delegate = pinDelegate(state,self)
...
# =============================================================================
        ...
        directMenu.triggered.connect(lambda: self.executeTool())
...
# =============================================================================
#         control.setStyleSheet(("border: 1px solid rgba(65,67,77, 100%);"
#                             "font-family : Comfortaa;"
#                             "color: rgb(255,255,245);"
#                             "font-size: 13px;"
#                             "background-color: rgb(41,178,170);"
...
# =============================================================================
        ...
        board.addAction(self.connect)
        board.addAction(self.disconnect)
        board.addAction(self.quickRefresh)
        self.quickRefresh.triggered.connect(lambda: self.processCommand())

        #create submenu
        self.directonOFF = MySwitch("on/off")
        self.directonOFF.setCheckable(True)
        self.directonOFF.clicked.connect(lambda: self.__optionUpdated("on/off", self.directonOFF.isChecked()))
...
# =============================================================================
#         board.setStyleSheet(("border: 1px solid rgba(65,67,77, 100%);"
#                             "font-family : Comfortaa;"
#                             "color: rgb(255,255,245);"
#                             "font-size: 13px;"
#                             "background-color: rgb(41,178,170);"
...
#         self.direct.triggered.connect(lambda: self.__toolSelected("direct", "({on/off})"))
# =============================================================================
